<template>
    <div class="main" ref="main">
        <div class="list">
            <div class="option">
                <div class="left_fade">市植株总量</div>
                <div class="right_fade"><span class="num">{{'112242'}}</span><span> 株</span></div>
            </div>
            <div class="option">
                <div class="left_fade">绿化覆盖率</div>
                <div class="right_fade"><span class="num">{{'25.78'}}</span><span> %</span></div>
            </div>
            <div class="option">
                <div class="left_fade">环卫站箱清理频率</div>
                <div class="right_fade"><span class="num">{{'78'}}</span><span> %</span></div>
            </div>
        </div>
    </div>
</template>
